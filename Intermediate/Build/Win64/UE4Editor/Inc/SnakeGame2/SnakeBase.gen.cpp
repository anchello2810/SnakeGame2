...
#include "SnakeGame2/SnakeBase.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	SNAKEGAME2_API UEnum* Z_Construct_UEnum_SnakeGame2_EMovementDirection();
	UPackage* Z_Construct_UPackage__Script_SnakeGame2();
	SNAKEGAME2_API UClass* Z_Construct_UClass_ASnakeBase_NoRegister();
	SNAKEGAME2_API UClass* Z_Construct_UClass_ASnakeBase();
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	SNAKEGAME2_API UFunction* Z_Construct_UFunction_ASnakeBase_Move();
	SNAKEGAME2_API UFunction* Z_Construct_UFunction_ASnakeBase_SnakeElementOverlap();
...
// End Cross Module References
	static UEnum* EMovementDirection_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_SnakeGame2_EMovementDirection, Z_Construct_UPackage__Script_SnakeGame2(), TEXT("EMovementDirection"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EMovementDirection(EMovementDirection_StaticEnum, TEXT("/Script/SnakeGame2"), TEXT("EMovementDirection"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_SnakeGame2_EMovementDirection_Hash() { return 3921777951U; }
	UEnum* Z_Construct_UEnum_SnakeGame2_EMovementDirection()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_SnakeGame2();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EMovementDirection"), 0, Get_Z_Construct_UEnum_SnakeGame2_EMovementDirection_Hash(), false);
#else
	...
	IMPLEMENT_CLASS(ASnakeBase, 137657512);
	template<> SNAKEGAME2_API UClass* StaticClass<ASnakeBase>()
	{
		return ASnakeBase::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ASnakeBase(Z_Construct_UClass_ASnakeBase, &ASnakeBase::StaticClass, TEXT("/Script/SnakeGame2"), TEXT("ASnakeBase"), false, nullptr, nullptr, nullptr);
